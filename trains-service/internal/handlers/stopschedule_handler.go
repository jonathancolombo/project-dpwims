...
// GetStopSchedule a handler method to get a stop schedule by id from repository memory
...
// GetAllStopSchedules a handler method to get all stop schedules from repository memory
...
// DeleteStopSchedule a handler method to delete a stop schedule by id from repository memory
...
// UpdateStopSchedule a handler method to update a schedule by id from repository memory
