...
// GetSchedule a handler method to get a schedule by id from repository memory
...
// GetAllSchedules a handler method to get all schedules from repository memory
...
// DeleteSchedule a handler method to delete a schedule by id from repository memory
...
// UpdateSchedule a handler method to update a schedule by id from repository memory
