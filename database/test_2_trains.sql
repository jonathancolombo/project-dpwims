...
INSERT INTO schedules_stops (id, schedule_id, station_id, stop_order, arrival_time, departure_time)
VALUES
  (1, 1, 1, 1, '2026-02-11 07:00:00', '2026-02-11 07:05:00'),
  (2, 1, 5, 2, '2026-02-11 09:00:00', '2026-02-11 09:05:00'),
  (3, 1, 2, 3, '2026-02-11 11:30:00', '2026-02-11 11:35:00')
ON DUPLICATE KEY UPDATE
  schedule_id = VALUES(schedule_id), station_id = VALUES(station_id), stop_order = VALUES(stop_order), arrival_time = VALUES(arrival_time), departure_time = VALUES(departure_time);

-- Schedule 2 (Milano -> Bologna -> Napoli)
INSERT INTO schedules_stops (id, schedule_id, station_id, stop_order, arrival_time, departure_time)
VALUES
  (4, 2, 2, 1, '2026-02-11 08:00:00', '2026-02-11 08:05:00'),
  (5, 2, 5, 2, '2026-02-11 10:30:00', '2026-02-11 10:35:00'),
  (6, 2, 3, 3, '2026-02-11 14:00:00', '2026-02-11 14:05:00')
ON DUPLICATE KEY UPDATE
  schedule_id = VALUES(schedule_id), station_id = VALUES(station_id), stop_order = VALUES(stop_order), arrival_time = VALUES(arrival_time), departure_time = VALUES(departure_time);
...
INSERT INTO schedules_stops (id, schedule_id, station_id, stop_order, arrival_time, departure_time)
VALUES
  (7, 3, 5, 1, '2026-02-11 09:00:00', '2026-02-11 09:05:00'),
  (8, 3, 4, 2, '2026-02-11 10:15:00', '2026-02-11 10:20:00')
ON DUPLICATE KEY UPDATE
  schedule_id = VALUES(schedule_id), station_id = VALUES(station_id), stop_order = VALUES(stop_order), arrival_time = VALUES(arrival_time), departure_time = VALUES(departure_time);
